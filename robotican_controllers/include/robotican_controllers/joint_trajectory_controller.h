...
#ifndef ROBOTICAN_CONTROLLERS_JOINT_TRAJECTORY_CONTROLLE_H
#define ROBOTICAN_CONTROLLERS_JOINT_TRAJECTORY_CONTROLLE_H
...
#endif //ROBOTICAN_CONTROLLERS_JOINT_TRAJECTORY_CONTROLLE_H
