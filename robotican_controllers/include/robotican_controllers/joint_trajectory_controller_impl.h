...
#ifndef ROBOTICAN_CONTROLLERS_JOINT_TRAJECTORY_CONTROLLER_IMPL_H
#define ROBOTICAN_CONTROLLERS_JOINT_TRAJECTORY_CONTROLLER_IMPL_H
...
#endif //ROBOTICAN_CONTROLLERS_JOINT_TRAJECTORY_CONTROLLER_IMPL_H
