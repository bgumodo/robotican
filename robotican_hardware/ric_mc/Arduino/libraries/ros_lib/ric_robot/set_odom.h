#ifndef _ROS_SERVICE_set_odom_h
#define _ROS_SERVICE_set_odom_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SET_ODOM[] = "ric_robot/set_odom";

  class set_odomRequest : public ros::Msg
  {
    public:
      float x;
      float y;
    ...
    const char * getType(){ return SET_ODOM; };
    const char * getMD5(){ return "a130bc60ee6513855dc62ea83fcc5b20"; };

  };

  class set_odomResponse : public ros::Msg
  {
    public:
